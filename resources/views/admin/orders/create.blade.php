                            ...
                            <table class="w-full">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-3.5 py-4 border-b border-dashed first:pl-0 last:pr-0 border-slate-200 dark:border-zink-500 ltr:text-right rtl:text-left">{{ $list->product_variant->price_sale }}</td>
                                    </tr>
                                    @endforeach
                                    <div>
                                    <tr>
                                    ...
                                    <tr class="font-semibold">
                                        ...
                                        <td class="px-3.5 pt-3 first:pl-0 last:pr-0 ltr:text-right rtl:text-left">${{ $cart->total_amuont}}</td>
                                    </tr>

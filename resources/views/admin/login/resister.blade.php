    ...
    <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
        <div class="!px-10 !py-12 card-body">
            ...
            <form action="../login/resister" class="mt-10" id="registerForm" method="post">
                ...
                <div class="mb-3">
                    <label for="sdt-field" class="inline-block mb-2 text-base font-medium">sdt</label>
                    <input type="text" id="sdt-field" name="sdt" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Enter username">
                    <div id="sdt-error" class="hidden mt-1 text-sm text-red-500">Please enter a username.</div>
                </div>
                <div class="mb-3">

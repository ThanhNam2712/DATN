                            ...
                            @csrf
                                <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                                    ...
                                    <div class="xl:col-span-4">
                                        ...
                                        <input type="number" min="1" name="discount_value" id="valueDiscount" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder=" < 100">
                                    ...
                                    <div class="xl:col-span-4">
                                        ...
                                        <input type="number" name="Nhập giá trị" id="productPrice" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder="Minimum amount">
                                    ...
                                    <div class="xl:col-span-4">
                                        <label for="dateCouponSt" class="inline-block mb-2 text-base font-medium">Ngày Bắt Đầu</label>
                                    ...
                                    <div class="xl:col-span-4">
                                        <label for="dateCouponEn" class="inline-block mb-2 text-base font-medium">Ngày Kết Thúc</label>
                                    ...
                                    <div class="xl:col-span-4">
                                        <label for="productQuantity" class="inline-block mb-2 text-base font-medium">Số Lượng Giảm Giá</label>

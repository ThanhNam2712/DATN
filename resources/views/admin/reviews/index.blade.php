                            ...
                            <div class="card-body">
                                ...
                                <div class="flex flex-wrap items-center gap-2">
                                    @foreach($product->variant as $key => $size)
                                        <div>
                                            <input id="selectSize{{ $size->size->name }}" class="hidden peer" type="radio" value="{{ $size->size->name }}" name="selectSize">
                                ...
                                <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                                    ...
                                    <div class="xl:col-span-8">
                                        ...
                                        @else
                                            @foreach($product->review as $key => $review)
                                                <div class="pt-3 mt-3 border-t border-slate-200 dark:border-zink-500">
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <div class="grow">
                                                            ...
                                                            <p class="text-sm text-slate-500 dark:text-zink-200">{{ $review->updated_at->format('Y-m-d') }}</p>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <p class="text-slate-500 dark:text-zink-200">"{{ $review->comment }}."</p>
    ...
    <div id="addReviewsModal" modal-center="" class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
        <div class="w-screen lg:xl:w-[55rem] bg-white shadow rounded-md dark:bg-zink-600">
            ...
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                <form action="../admin/review/post" method="post">
                    <div class="grid grid-cols-1 gap-5 xl:grid-cols-12">
                            @csrf
                            <div class="xl:col-span-4">
                                <div>

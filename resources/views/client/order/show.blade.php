                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td
                                                ...
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        ...
                                                        <img src="{{ Storage::url($list->products->image) }}" alt=""
                                                            class="h-8">
                                                    </div>
                                                    <div class="grow">
                                                        <h6 class="mb-1 text-15"><a
                                                                ...
                                                                $list->products->name }}</a></h6>
                                                        <p class="text-slate-500 dark:text-zink-200">${{
                                                            $list->product_variants->price_sale }} x {{ $list->quantity
                                                            }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td
                                                ...
                                                ${{ number_format($list->product_variants->price_sale * $list->quantity)
                                                }}</td>
                                        </tr>
                                        @endforeach
                                        <tr>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="flex items-center gap-3 mb-4">
                                ...
                                <div class="shrink-0">
                                    <a href="../client/home"
                                        class="btn inline-block text-red-500 underline ltr:mr-2 rtl:ml-2">Cancelled
                                        Order</a>
                            ...
                            <div>
                                ...
                                <div
                                    ...
                                    <div class="flex gap-4">
                                        <div class="grow">
                                            <h6 class="mb-2 text-gray-800 text-15 dark:text-zink-50">Order Processing
                                            </h6>
                                            <p class="text-gray-400 dark:text-zink-200">Once the order is received, it
                                                goes through the processing stage. During this time, the items are
                                                gathered, and the order is prepared for shipment.</p>
                                        </div>
                                        <p class="text-sm text-gray-400 dark:text-zink-200 shrink-0">02 Nov, 2023</p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <div class="flex gap-4">
                                        <div class="grow">
                                            <h6 class="mb-2 text-gray-800 text-15 dark:text-zink-50">Out for Delivery
                                            </h6>
                                            <p class="text-gray-400 dark:text-zink-200">This status indicates that the
                                                order is currently out for delivery by the shipping or courier company.
                                            </p>
                                        </div>
                                    ...
                                    <div class="flex gap-4">
                                        <div class="grow">
                                            ...
                                            <p class="text-gray-400 dark:text-zink-200">Finally, when the order
                                                successfully reaches the customer's address and is handed over, the
                                                status changes to "Delivered."</p>
                                        </div>
                                ...
                                <div class="card-body">
                                    <div
                                        ...
                                        <img src="{{ Storage::url($order->user->avatar) }}" alt=""
                                            style="width: auto; height: auto" class="h-12 rounded-md">
                                    </div>

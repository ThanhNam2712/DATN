...
{{--                                            </div>--}}
                                            ...
                                            {{--  <div class="flex items-center gap-3 mt-3 justify-evenly">
                                                <a href="https://www.facebook.com/sharer/sharer.php?u={URL}" class="transition-all duration-300 ease-linear hover:text-custom-500"><i data-lucide="repeat" class="inline-block align-middle size-3 ltr:mr-1 rtl:ml-1"></i> <span class="align-middle">Compare</span></a>

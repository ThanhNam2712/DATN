...
@if(Session::has('success'))
    ...
    <div class="relative">
        ...
        <div class="mb-0 w-screen lg:w-[500px] card shadow border border-black shadow relative">
            <div class="!px-10 !py-12 card-body">
                <div class="mt-8 text-center">
                    <h3 class="mb-1 text-custom-500 dark:text-custom-500">Đăng Nhập</h3>
                </div>

                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        <div class="col-6"
                            ...
                            <br>
                            <span>
                                <a style="color: white !important;" href="mailto:{{ $order->accountCoupon->email }}" target="_blank">{{ $order->accountCoupon->email }}</a>
                            </span>
                            <br>
                            <span>{{ $order->accountCoupon->phone }}</span>
                        </div>
                        <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            ...
                            <br>
                            <b>Address:</b> {{ $order->accountCoupon->email }}
                        </div>
                    </div>
                </div>
            </div>

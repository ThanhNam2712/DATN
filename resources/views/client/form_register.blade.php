            ...
            <div class="mb-0 w-screen lg:w-[500px] card shadow-lg border-none shadow-slate-100 relative">
                ...
                @endif
                    <form action="{{ route('account.register') }}" method="POST" class="mt-10" id="registerForm">
                        ...
                        <div class="mb-3">
                            <label for="username-field"  class="inline-block mb-2 text-base font-medium">Tên đăng nhập</label>
                            <input type="text" id="username-field" name="name" class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200" placeholder=" Tên đăng nhập">
                        </div>
                        <div class="mb-3">
                        ...
                        <p class="italic text-15 text-slate-500 dark:text-zink-200">Bằng cách đăng ký, bạn đồng ý với điều khoản sử dụng AE Store<a href="#!" class="underline"> Điều khoản</a></p>
                        <div class="mt-10">
                            <button type="submit" class="w-full text-white transition-all duration-200 ease-linear btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">Đăng Ký</button>
                        </div>
                        ...
                        <div class="relative text-center my-9 before:absolute before:top-3 before:left-0 before:right-0 before:border-t before:border-t-slate-200 dark:before:border-t-zink-500">
                            <h5 class="inline-block px-2 py-0.5 text-sm bg-white text-slate-500 dark:bg-zink-600 dark:text-zink-200 rounded relative">Tạo tài khoản với</h5>
                        </div>
